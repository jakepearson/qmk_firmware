...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_69_ansi(
        ...
        ALL_T(KC_ESC), LSFT_T(KC_A),     KC_S,   KC_D,     LGUI_T(KC_F),    KC_G,              KC_H, RGUI_T(KC_J),  KC_K,   KC_L,     RSFT_T(KC_SCLN),  KC_QUOT,  KC_ENT,           KC_HOME,
        KC_LSFT,           KC_Z,   KC_X,    KC_C,    KC_V,  KC_B,    KC_B,    KC_N,  KC_M,   KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, KC_UP,
        KC_LCTL, KC_LOPTN, KC_LCMMD, LALT_T(KC_SPC),  CMD_SHIFT_P, MO(MAC_FN3),       KC_SPC,            LCMD(KC_QUOT),           KC_LEFT, KC_DOWN, KC_RGHT),
